...
export function mapVisionCameraResult(raw) {
  ...
  const docType = detectDocumentType(
    (_a = raw.documentType) !== null && _a !== void 0 ? _a : '',
  );
  const fields = {
    surname:
      (_c =
        (_b = raw.surname) !== null && _b !== void 0 ? _b : raw.lastName) !==
        null && _c !== void 0
        ? _c
        : null,
    givenNames:
      (_e =
        (_d = raw.givenNames) !== null && _d !== void 0
          ? _d
          : raw.firstName) !== null && _e !== void 0
        ? _e
        : null,
    ...
    dateOfBirth:
      (_j =
        (_h = raw.birthDate) !== null && _h !== void 0
          ? _h
          : raw.dateOfBirth) !== null && _j !== void 0
        ? _j
        : null,
    sex: normalizeSex(raw.sex),
    expirationDate:
      (_l =
        (_k = raw.expirationDate) !== null && _k !== void 0
          ? _k
          : raw.dateOfExpiry) !== null && _l !== void 0
        ? _l
        : null,
    documentNumber:
      (_m = raw.documentNumber) !== null && _m !== void 0 ? _m : null,
    personalNumber:
      (_o = raw.personalNumber) !== null && _o !== void 0 ? _o : null,
  };
  return {
